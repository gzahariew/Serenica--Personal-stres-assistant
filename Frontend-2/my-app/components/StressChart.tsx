...
export const StressChart: React.FC<StressChartProps> = ({ 
  ...
  const { isAuthorized, isLoading: isAuthLoading, error: authError, authorize } = useGoogleFit();
...
// const StressChart: React.FC<StressChartProps> = ({ userProfile  }) => {
//   console.log("User profile in StressChart:", userProfile);

//   const chartData = {
//     labels: Array.from({ length: 24 }, (_, i) => `${i}:00`),
//     datasets: [{
//       data: Array.from({ length: 24 }, (_, i) => Math.random() * 100), // Replace with actual data
//     }],
//   };
